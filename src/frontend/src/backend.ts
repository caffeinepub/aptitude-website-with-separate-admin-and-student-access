...
export class Backend implements backendInterface {
    ...
    async bootstrap_admin_role(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bootstrap_admin_role(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getById(arg0: bigint): Promise<Question> {
        if (this.processError) {
            try {
                const result = await this.actor.getById(arg0);
                return from_candid_Question_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitAnswers(arg0: Array<Answer>): Promise<Submission> {
        if (this.processError) {
            try {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        topic: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.topic)),
